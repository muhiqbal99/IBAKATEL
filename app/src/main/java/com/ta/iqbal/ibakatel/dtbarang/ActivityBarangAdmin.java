...
public class ActivityBarangAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_barang_admin);
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(ActivityBarangAdmin.this, EditorActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(ActivityBarangAdmin.this, EditorActivity.class));
            }
        });
    ...
    public void getBarang(){
        ...
        call.enqueue(new Callback<List<Barang>>() {
            ...
            public void onResponse(Call<List<Barang>> call, Response<List<Barang>> response) {
                ...
                Log.i(ActivityBarangAdmin.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(barangList, ActivityBarangAdmin.this, listener);
            ...
            public void onFailure(Call<List<Barang>> call, Throwable t) {
                Toast.makeText(ActivityBarangAdmin.this, "rp :"+
