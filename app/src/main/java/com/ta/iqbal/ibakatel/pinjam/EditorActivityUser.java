...
public class EditorActivityUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_pinjam_user);
        ...
        mTgl_pinjam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(EditorActivityUser.this, date, myCalendar
        ...
        mTgl_balik.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new DatePickerDialog(EditorActivityUser.this, date2, myCalendar
                        .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
    ...
    private void setDataFromIntentExtra() {
        ...
        if (id != 0) {
            ...
            Glide.with(EditorActivityUser.this)
                    .load(gambar)
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.menu_editor_user, menu);
        action = menu;
        ...
        call.enqueue(new Callback<Pinjam>() {
            ...
            public void onResponse(Call<Pinjam> call, Response<Pinjam> response) {
                ...
                if (value.equals("1")){
                    ...
                    Toast.makeText(EditorActivityUser.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Pinjam> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(EditorActivityUser.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
