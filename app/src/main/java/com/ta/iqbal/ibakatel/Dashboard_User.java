...
import com.ta.iqbal.ibakatel.dtbarang.ActivityBarangUser;
import com.ta.iqbal.ibakatel.pinjam.ActivityPinjamUser;
import com.ta.iqbal.ibakatel.identifikasi.QRCodeScanActivity;
import com.ta.iqbal.ibakatel.tutorial.tutorial;


/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link Dashboard_User.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Dashboard_User#newInstance} factory method to
...
public class Dashboard_User extends Fragment {
     ...
     * @return A new instance of fragment Dashboard_User.
     */
    // TODO: Rename and change types and number of parameters
    public static Dashboard_User newInstance(String param1, String param2) {
        Dashboard_User fragment = new Dashboard_User();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.dashboard_user, container, false);

        LinearLayout linearlayout = (LinearLayout) v.findViewById(R.id.list_item);
        linearlayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), ActivityBarangUser.class);
                startActivity(intent);
            }
        });
        ...
        linearlayout2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), ActivityPinjamUser.class);
                startActivity(intent);
            }
        });

        LinearLayout linearlayout3 = (LinearLayout) v.findViewById(R.id.tutorial);
        ...
        Button button = (Button) v.findViewById(R.id.btn_scan);
