...
public class EditorActivity extends AppCompatActivity {
    ...
    private void postData(final String key) {
        ...
        Call<Laporan> call = apiInterface.tambahLaporan(key, nm_barang, tgl_pinjam, tgl_balik, nm_user, gambar, status, catatan);
    ...
    private void updateData(final String key, final int id) {
        ...
        Call<Laporan> call = apiInterface.perbaruiLaporan(key, id, nm_barang, tgl_pinjam, tgl_balik, nm_user, gambar, status, catatan);
    ...
    private void deleteData(final String key, final int id, final String pic) {
        ...
        Call<Laporan> call = apiInterface.hapusLaporan(key, id, pic);
